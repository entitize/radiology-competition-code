...
python run_baseline.py --epochs 20 --batch_size 64 --num_workers 15 --lr_patience 5 --custom_save lr_exps_5 \
--model_type EfficientNetB0 --dataset_dir /groups/CS156b/teams/ups_data/224_data --restore_best_weights \
--learning_rate 0.00001 --load_pretrained lr_exps_4