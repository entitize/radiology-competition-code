...
python run_baseline.py --epochs 5 --batch_size 8 --num_workers 15 --lr_patience 5 --model_type EfficientNetB4 --dataset_dir /groups/CS156b/teams/ups_data/380_data \
--diseases $DISEASE --nan_fill_mode remove_nan_rows --restore_best_weights --ensemble_best_epochs 2 \
--custom_save_dir mlp_EfficientNetB4 --custom_save mlp_EfficientNetB4_$DISEASE --multi_gpu
