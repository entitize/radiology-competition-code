...
python run_baseline.py --epochs 10 --batch_size 16 --num_workers 15 --lr_patience 5 --model_type EfficientNetB0 --dataset_dir /groups/CS156b/teams/ups_data/224_data \
--diseases $DISEASE --nan_fill_mode remove_nan_rows --restore_best_weights --ensemble_best_epochs 2 \
--custom_save_dir inds_exps_22 --custom_save inds_exps_22_$DISEASE --learning_rate 0.000001
