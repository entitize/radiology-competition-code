...
--diseases $DISEASE --custom_save inds_exps_12_$DISEASE --nan_fill_mode remove_nan_rows --restore_best_weights --learning_rate 0.00001 \
--custom_save_dir inds_exps_12