...
--custom_save_dir inds_exps_32 --custom_save inds_exps_32_lateral_$DISEASE --nan_fill_mode remove_nan_rows --data_mode lateral

python run_baseline.py --epochs 5 --batch_size 16 --num_workers 15 --lr_patience 5 --model_type EfficientNetB0 --dataset_dir /groups/CS156b/teams/ups_data/224_data \
--diseases $DISEASE --restore_best_weights --learning_rate 0.00001 \
--custom_save_dir inds_exps_32 --custom_save inds_exps_32_frontal_$DISEASE --nan_fill_mode remove_nan_rows --data_mode frontal