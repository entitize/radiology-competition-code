...
#SBATCH -J "inds_exps_g3"   # job name
...
python run_baseline.py --epochs 5 --batch_size 32 --multi_gpu --num_workers 15 --learning_rate 3e-4 --lr_patience 5 --save_prefix inds_exps1 --model_type EfficientNetB4 --dataset_dir /groups/CS156b/teams/ups_data/380_data \
--diseases g3 --custom_save inds_exps_1_g3_b4
