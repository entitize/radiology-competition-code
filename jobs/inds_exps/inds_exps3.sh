...
python run_baseline.py --epochs 5 --batch_size 64 --num_workers 15 --lr_patience 5 --save_prefix inds_exps3 --model_type DenseNet201 --dataset_dir /groups/CS156b/teams/ups_data/224_data \
--diseases $DISEASE --custom_save inds_exps_3_$DISEASE --loss_func weighted-one-class
