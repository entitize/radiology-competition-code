...
python run_baseline.py --epochs 5 --batch_size 64 --num_workers 15 --lr_patience 5 --model_type ResNet152 --dataset_dir /groups/CS156b/teams/ups_data/224_data \
--diseases $DISEASE --custom_save inds_exps_6_$DISEASE --nan_fill_mode remove_nan_rows --restore_best_weights --ensemble_best_epochs 2
