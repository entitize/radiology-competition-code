...
python run_baseline.py --epochs 5 --batch_size 64 --num_workers 15 --lr_patience 5 --custom_save d_card_3 \
--model_type DenseNet121 --dataset_dir /groups/CS156b/teams/ups_data/224_data --restore_best_weights \
--diseases 2 --nan_fill_mode remove_nan_rows --ensemble_best_epochs 2 --custom_save_dir h_group