...
python run_baseline.py --epochs 5 --batch_size 64 --num_workers 15 --lr_patience 5 --custom_save h2_1 \
--model_type EfficientNetB0 --dataset_dir /groups/CS156b/teams/ups_data/224_data --restore_best_weights --custom_save_dir h_group \
--diseases h2 --ensemble_best_epochs 2