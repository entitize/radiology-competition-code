...
#SBATCH -J "sanity_base_2"   # job name
...
python run_baseline.py --epochs 5 --batch_size 64 --num_workers 15 --lr_patience 5 --custom_save sanity_base_2 \
--model_type EfficientNetB0 --dataset_dir /groups/CS156b/teams/ups_data/224_data --restore_best_weights --monitor val_accuracy