...
python run_baseline.py --epochs 5 --batch_size 64 --num_workers 15 --lr_patience 5 --save_prefix nan_exps1 \
--model_type EfficientNetB0 --dataset_dir /groups/CS156b/teams/ups_data/224_data \
--nan_fill_mode random --min_rand_nan -1 --max_rand_nan 1