...
python run_baseline.py --epochs 20 --batch_size 128 --num_workers 15 --lr_patience 6 --custom_save pony_6_3 \
--model_type EfficientNetB0 --dataset_dir /groups/CS156b/teams/ups_data/224_data --restore_best_weights --ensemble_best_epochs 3 \
