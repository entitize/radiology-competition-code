...
python run_baseline.py --epochs 20 --batch_size 128 --num_workers 15 --lr_patience 6 --custom_save pony_6_7 \
...
--lr_reducer_patience 3 --multi_gpu --generator aug
