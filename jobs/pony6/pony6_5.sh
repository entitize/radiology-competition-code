...
python run_baseline.py --epochs 20 --batch_size 64 --num_workers 15 --lr_patience 6 --custom_save pony_6_5 \
--model_type ResNet152 --dataset_dir /groups/CS156b/teams/ups_data/380_data --img_size 380 --restore_best_weights --ensemble_best_epochs 3 \
