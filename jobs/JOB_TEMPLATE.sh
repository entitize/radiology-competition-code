...
cd /home/knakamur/unemployed_pony_spuds/main #TODO

python run_baseline.py --epochs 5 --batch_size 64 --num_workers 15 --lr_patience 5 --save_prefix #TODO \
