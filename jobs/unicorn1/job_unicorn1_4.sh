...
CUDA_VISIBLE_DEVICES=0 python run_baseline.py --epochs 10 --batch_size 64 --num_workers 15 --lr_patience 5 --save_prefix unicorn1 --model_type EfficientNetB0 --no_multiprocessing