...
python run_baseline.py --epochs 5 --batch_size 16 --num_workers 10 --lr_patience 3 --custom_save size_exps_1 \
--model_type EfficientNetB1 --dataset_dir /groups/CS156b/teams/ups_data/480_data --img_size 480 --restore_best_weights