...
#SBATCH -J "ml_EfficientNetB0"   # job name #CHANGEME
...
python run_baseline.py --epochs 5 --batch_size 32 --num_workers 15 --lr_patience 5 --custom_save ml_EfficientNetB0 \ 
--model_type EfficientNetB0 --dataset_dir /groups/CS156b/teams/ups_data/224_data --learning_rate 0.0003
