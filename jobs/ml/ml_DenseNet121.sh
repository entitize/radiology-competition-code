...
#SBATCH -J "ml_DenseNet121"   # job name #CHANGEME
...
python run_baseline.py --epochs 5 --batch_size 32 --num_workers 15 --lr_patience 5 --custom_save ml_DenseNet121 \ 
--model_type DenseNet121 --dataset_dir /groups/CS156b/teams/ups_data/224_data
