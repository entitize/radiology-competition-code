...
#SBATCH -J "ml_EfficientNetB5"   # job name #CHANGEME
...
python run_baseline.py --epochs 5 --batch_size 8 --num_workers 15 --lr_patience 5 --custom_save ml_EfficientNetB5 \ 
--model_type EfficientNetB5 --dataset_dir /groups/CS156b/teams/ups_data/456_data --learning_rate 0.0003 --multi_gpu
