...
#SBATCH -J "ml_EfficientNetB4"   # job name #CHANGEME
...
python run_baseline.py --epochs 5 --batch_size 16 --num_workers 15 --lr_patience 5 --custom_save ml_EfficientNetB4 \ 
--model_type EfficientNetB4 --dataset_dir /groups/CS156b/teams/ups_data/380_data --learning_rate 0.0003 --multi_gpu
