...
#SBATCH -J "pony5_1_DenseNet169_kf3"   # job name
...
cd main
python run_baseline.py --epochs 5 --use_k_folds --k 3 --lr_reducer_patience 1 --batch_size 64 --num_workers 15 --learning_rate 3e-4 --lr_patience 5 --save_prefix pony5 --save_postfix k3 --model_type DenseNet169 --dataset_dir /groups/CS156b/teams/ups_data/224_data