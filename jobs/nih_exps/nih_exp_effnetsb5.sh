...
#SBATCH -J "nih_exp_effnetb5"   # job name
...
python run_baseline.py --epochs 5 --batch_size 32 --num_workers 15 --lr_patience 5 --custom_save nih_effnetB5 \
--model_type EfficientNetB5 --multi_gpu --restore_best_weights \
--dataset_type nih --dataset_dir /groups/CS156b/teams/ups_data/nih_456