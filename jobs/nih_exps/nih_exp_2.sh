...
python run_baseline.py --epochs 5 --batch_size 64 --num_workers 15 --lr_patience 5 --custom_save nih_exp_2 \
--model_type EfficientNetB0 --restore_best_weights \
--dataset_dir /groups/CS156b/teams/ups_data/224_data \
--load_pretrained nih_exp_1 --print_model_summary --remove_top