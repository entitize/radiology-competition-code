...
#SBATCH -J "nih_exp_effnetb4"   # job name
...
python run_baseline.py --epochs 5 --batch_size 64 --num_workers 15 --lr_patience 5 --custom_save nih_effnetB4 \
--model_type EfficientNetB4 --multi_gpu --restore_best_weights \
--dataset_type nih --dataset_dir /groups/CS156b/teams/ups_data/nih_380