...
python run_baseline.py --epochs 5 --batch_size 64 --num_workers 15 --lr_patience 5 --custom_save nih_exp_4 \
--model_type EfficientNetB0 --restore_best_weights \
--dataset_dir /groups/CS156b/teams/ups_data/224_data \
--load_pretrained nih_exp_3 --learning_rate 0.00001