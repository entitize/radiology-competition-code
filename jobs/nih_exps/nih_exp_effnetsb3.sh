...
#SBATCH -J "nih_exp_effnetb3"   # job name
...
python run_baseline.py --epochs 5 --batch_size 64 --num_workers 15 --lr_patience 5 --custom_save nih_effnetB3 \
--model_type EfficientNetB3 --multi_gpu --restore_best_weights \
