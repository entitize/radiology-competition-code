...
#SBATCH -J "nih_pretrain_DenseNet201"   # job name
...
python run_baseline.py --epochs 5 --batch_size 16 --num_workers 15 --lr_patience 5 --custom_save nih_pretrain_DenseNet201 \
--model_type DenseNet201 --restore_best_weights \
