...
#SBATCH -J "nih_pretrain_EfficientNetV2S"   # job name
...
python run_baseline.py --epochs 5 --batch_size 16 --num_workers 15 --lr_patience 5 --custom_save nih_pretrain_EfficientNetV2S \
--model_type EfficientNetV2S --restore_best_weights \
--dataset_type nih --dataset_dir /groups/CS156b/teams/ups_data/nih_224 --img_size 224 --multi_gpu