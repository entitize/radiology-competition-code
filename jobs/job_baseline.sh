...
#SBATCH -J "effnet_baseline_gpu"   # job name
...
cd ../main
CUDA_VISIBLE_DEVICES=0 python run_baseline.py --epochs 10 --batch_size 128 --num_workers 10 --save_postfix unfrozen --model_type InceptionV3