...
python run_baseline.py --epochs 5 --batch_size 32 --num_workers 15 --lr_patience 5 --custom_save pony7_3 \
--model_type EfficientNetB3 --dataset_dir /groups/CS156b/teams/ups_data/300_data --restore_best_weights