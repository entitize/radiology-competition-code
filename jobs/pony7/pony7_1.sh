...
python run_baseline.py --epochs 5 --batch_size 8 --num_workers 15 --lr_patience 5 --custom_save pony7_1 \
--model_type EfficientNetB6 --dataset_dir /groups/CS156b/teams/ups_data/528_data --restore_best_weights