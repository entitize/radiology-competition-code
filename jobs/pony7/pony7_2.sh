...
python run_baseline.py --epochs 5 --batch_size 4 --num_workers 15 --lr_patience 5 --custom_save pony7_2 \
--model_type EfficientNetB7 --dataset_dir /groups/CS156b/teams/ups_data/576_data --img_size 576 --restore_best_weights